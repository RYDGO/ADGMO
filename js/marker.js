    ...
    var n = function () {
        ...
        d = function () {
            ...
            return t.prototype.show = function (t) {
                ...
                $(s).attr("data-bs-toggle", "modal");
                $(s).attr("data-bs-target", "#CommentsAssetsModal")
                ...
                switch (o.className = "" + this.toolbarButtonStyleClass.name, o.innerHTML = e, o.setAttribute("data-action", i), o.addEventListener("click", (function () {
                    ...
                    case "render":
                        ...
                        o.setAttribute('id', 'okEditButton');
                        o.classList.add("hidden")
                        break;
                    case "close":
                        o.style.fill = this.uiStyleSettings.closeButtonColor;
                        o.classList.add("bg-transparent")
                }
                console.log("button check", o);
        ...
        K = function () {
            ...
            return Object.defineProperty(t.prototype, "ALL_MARKER_TYPES", {
                ...
                if (void 0 === t && (t = !1), this.isOpen) {
                    ...
                    })), i || (this.coverDiv && this.closeUI(), this.targetObserver && this.targetObserver.unobserve(this.target), "popup" === this.settings.displayMode && window.removeEventListener("resize", this.setWindowHeight), this.eventListeners.close.forEach((function (t) {
                        return t(new F(e))
