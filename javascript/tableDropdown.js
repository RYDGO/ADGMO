...
function format(d) {
    ...
    return (
        ...
        d.status +
        '</p ></span ></td > ' +
        '<td class="py-2 table-pd-top border-bottom-0 table-pd-left"><i class="fa-regular fa-clock"></i>' + d.time_remainig + '</td > ' +
        '</tr>' +
        '</table>'
    );
}
    ...
    columnDefs: [
        {
            ...
            render: function (data, type, row, meta) {
                return '<td class="py-2 table-pd-top border-bottom-0 border-bottom-0 d-flex justify-content-center align-items-center"><div class="form-check mb-2"><input class="form-check-input shadow-none tb-bg-primary-checked" type="checkbox" value="" id="flexCheckDefault"></div><div class="d-flex align-items-center justify-content-center"><h6 class="bg-secondary align-self-center  rounded-pill p-1 mx-1 text-white text-center common-width-label-30 tb-fs-14 tb-fs-14">16</h6><h6 class="fs-6 fw-light">' +
                    data +
                    '</h6></div></td>';
            }
        },
        {
            ...
            data: "PRL(En)",
            render: function (data, type, row, meta) {
                return '<td class="py-2 table-pd-top border-bottom-0 table-pd-left">' +
                    data +
                    '</td>';
            }
        },
        ...
        },
        {
            ...
            data: "Under Review",
            render: function (data, type, row, meta) {
                return '<td class="py-3 border-bottom-0"><span class="d-flex align-items-center justify-content-evenly p-2 "><i class="text-base-black fa-xs fa-sharp fa-solid fa-circle "></i><p class="caption-paragraph mb-0 text-base-black">' +
                    data +
                    '</p ></span ></td >';
            }
        },
        {
            ...
            data: "2:05:00",
            render: function (data, type, row, meta) {
                return '<td class="py-2 table-pd-top border-bottom-0 table-pd-left"><i class="fa-regular fa-clock"></i>' + data + '</td > ';
            }
        },
