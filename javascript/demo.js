...
$('.__markerjs2__0_toolbar_button').on('click', function () {
    var toolbox = document.getElementsByClassName("__markerjs2__0_toolbox-button-row")
    // $('__markerjs2__0_toolbox-button-row')
    console.log("dsadaswdwa");
})
