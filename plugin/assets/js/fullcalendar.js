	...
	function DayEventRenderer() {
		...
		function buildHTMLForSegment(segment) {
			...
			if (url) {
				...
				html += "<div data-bs-target='#newEntry' data-bs-toggle='modal'";
			}
			html +=
				" class='" + classNames.join(' ') + "'" +
				" style=" +
				...
				"'" +
				">" +
				'<div class="card-left-box flex-center-align gap-1"><span class="tb-bg-purple d-flex align-items-center justify-content-evenly py-2 px-4 status-color-blue-op w-25"><h5 class="fs-5 mb-0 text-white text-center">KIZ</h5>' +
				'</span><span class="tb-bg-purple d-flex align-items-center justify-content-evenly py-2 px-4 status-color-blue-op  w-25"><h5 class="fs-5 mb-0 text-white text-center">KIZ</h5></span></div>' +
